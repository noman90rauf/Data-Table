/*!
 DataTables Editor v1.3.3.1 (for input type "file" and multiselect)
...
(function (t, n, l) {
    var w = function (d, u) {
        ...
        function x(a, b, c, d) {
            b || (b = {});
            b.buttons === l && (b.buttons = "_basic");
            b.title === l && (b.title = a.i18n[c].title);
            b.message === l && ("remove" === c ? (a = a.i18n[c].confirm, b.message = 1 !== d ? a._.replace(/%d/, d) : a["1"]) : b.message = "");
            return b
        }
        if (!u || !u.versionCheck("1.10"))
        ...
        e.Field = function (a, b, c) {
            var k = this, a = d.extend(!0, {}, e.Field.defaults, a);
            this.s = d.extend({}, e.Field.settings, {type: e.fieldTypes[a.type], name: a.name, classes: b, host: c, opts: a});
            ...
            this.dom = d.extend(!0, {}, e.Field.models.dom, {container: b, label: q("label", b), fieldInfo: q("msg-info", b), labelInfo: q("msg-label", b), fieldError: q("msg-error", b), fieldMessage: q("msg-message", b)});
            d.each(this.s.type, function (a, b) {
                typeof b === "function" && k[a] === l && (k[a] = function () {
        ...
        e.Field.models.dom = {container: null, label: null,
            labelInfo: null, fieldInfo: null, fieldError: null, fieldMessage: null};
        e.models = {};
        ...
        e.models.button = {label: null, fn: null,
            className: null};
        ...
        e.display = {};
        var m = jQuery, h;
        e.display.lightbox = m.extend(!0, {}, e.models.displayController, {init: function () {
                h._init();
                return h
            }, open: function (a, b, c) {
                if (h._shown)
                ...
                if (!h._ready) {
                    var a = h._dom;
                    a.content = m("div.DTED_Lightbox_Content", h._dom.wrapper);
                    a.wrapper.css("opacity", 0);
                    a.background.css("opacity", 0)
                }
            }, _show: function (a) {
                var b = h._dom;
                t.orientation !== l && m("body").addClass("DTED_Lightbox_Mobile");
                b.content.css("height", "auto");
                b.wrapper.css({top: -h.conf.offsetAni});
                m("body").append(h._dom.background).append(h._dom.wrapper);
                h._heightCalc();
                b.wrapper.animate({opacity: 1, top: 0}, a);
                ...
                m("div.DTED_Lightbox_Content_Wrapper", b.wrapper).bind("click.DTED_Lightbox", function (a) {
                    m(a.target).hasClass("DTED_Lightbox_Content_Wrapper") && h._dte.blur()
                });
                m(t).bind("resize.DTED_Lightbox", function () {
                    h._heightCalc()
                });
                h._scrollTop = m("body").scrollTop();
                a = m("body").children().not(b.background).not(b.wrapper);
                m("body").append('<div class="DTED_Lightbox_Shown"/>');
                m("div.DTED_Lightbox_Shown").append(a)
            },
            _heightCalc: function () {
                var a = h._dom, b = m(t).height() - h.conf.windowPadding * 2 - m("div.DTE_Header", a.wrapper).outerHeight() - m("div.DTE_Footer", a.wrapper).outerHeight();
                m("div.DTE_Body_Content", a.wrapper).css("maxHeight", b)
            }, _hide: function (a) {
                var b = h._dom;
                a || (a = function () {
                });
                var c = m("div.DTED_Lightbox_Shown");
                c.children().appendTo("body");
                c.remove();
                m("body").removeClass("DTED_Lightbox_Mobile").scrollTop(h._scrollTop);
                b.wrapper.animate({opacity: 0, top: h.conf.offsetAni}, function () {
                    m(this).detach();
                    a()
                });
                b.background.animate({opacity: 0}, function () {
                    m(this).detach()
                });
                b.close.unbind("click.DTED_Lightbox");
                b.background.unbind("click.DTED_Lightbox");
                m("div.DTED_Lightbox_Content_Wrapper", b.wrapper).unbind("click.DTED_Lightbox");
                m(t).unbind("resize.DTED_Lightbox")
            }, _dte: null, _ready: !1, _shown: !1, _dom: {wrapper: m('<div class="DTED_Lightbox_Wrapper"><div class="DTED_Lightbox_Container"><div class="DTED_Lightbox_Content_Wrapper"><div class="DTED_Lightbox_Content"></div></div></div></div>'), background: m('<div class="DTED_Lightbox_Background"><div/></div>'),
                close: m('<div class="DTED_Lightbox_Close"></div>'), content: null}});
        h = e.display.lightbox;
        h.conf = {offsetAni: 25, windowPadding: 25};
        var i = jQuery, f;
        e.display.envelope = i.extend(!0, {}, e.models.displayController, {init: function (a) {
                f._dte = a;
                f._init();
                return f
            }, open: function (a, b, c) {
                ...
                if (!f._ready) {
                    ...
                    n.body.appendChild(f._dom.wrapper);
                ...
                f._dom.background.style.display = "block";
                i(f._dom.background).animate({opacity: f._cssBackgroundOpacity}, "normal");
                i(f._dom.wrapper).fadeIn();
                f.conf.windowScroll ? i("html,body").animate({scrollTop: i(c).offset().top + c.offsetHeight - f.conf.windowPadding}, function () {
                    i(f._dom.content).animate({top: 0},
                    600, a)
                }) : i(f._dom.content).animate({top: 0}, 600, a);
                ...
                i(t).bind("resize.DTED_Envelope", function () {
                    f._heightCalc()
                })
            }, _heightCalc: function () {
                f.conf.heightCalc ? f.conf.heightCalc(f._dom.wrapper) : i(f._dom.content).children().height();
                var a = i(t).height() - f.conf.windowPadding * 2 - i("div.DTE_Header", f._dom.wrapper).outerHeight() - i("div.DTE_Footer", f._dom.wrapper).outerHeight();
                i("div.DTE_Body_Content", f._dom.wrapper).css("maxHeight", a);
                return i(f._dte.dom.wrapper).outerHeight()
            }, _hide: function (a) {
                a || (a = function () {
                });
                i(f._dom.content).animate({top: -(f._dom.content.offsetHeight + 50)}, 600, function () {
            ...
            }, _dte: null, _ready: !1, _cssBackgroundOpacity: 1, _dom: {wrapper: i('<div class="DTED_Envelope_Wrapper"><div class="DTED_Envelope_ShadowLeft"></div><div class="DTED_Envelope_ShadowRight"></div><div class="DTED_Envelope_Container"></div></div>')[0],
                background: i('<div class="DTED_Envelope_Background"><div/></div>')[0], close: i('<div class="DTED_Envelope_Close">&times;</div>')[0], content: null}});
        ...
        e.prototype.add = function (a) {
            if (d.isArray(a))
                ...
                if (this.s.fields[b])
                    throw"Error adding field '" + b + "'. A field already exists with this name";
        ...
        e.prototype.bubble = function (a, b, c) {
            ...
            e = d('<div class="' +
                    p.wrapper + '"><div class="' + p.liner + '"><div class="' + p.table + '"><div class="' + p.close + '" /></div></div><div class="' + p.pointer + '" /></div>').appendTo("body");
            p = d('<div class="' + p.bg + '"><div/></div>').appendTo("body");
            this._displayReorder(g);
            var y = e.children().eq(0), h = y.children(), i = h.children();
            y.append(this.dom.formError);
            h.prepend(this.dom.form);
            c.message && y.prepend(this.dom.formInfo);
            c.title && y.prepend(this.dom.header);
            c.buttons && h.append(this.dom.buttons);
            var j = d().add(e).add(p);
        ...
        e.prototype.bubblePosition = function () {
            ...
            var k = k / c.length, g = g / c.length, e = e / c.length, c = k, f = (g + e) / 2, p = b.outerWidth(),
                    h = f - p / 2, p = h + p, i = d(t).width();
            a.css({top: c, left: f});
        ...
        e.prototype.buttons = function (a) {
            var b = this;
            "_basic" === a ? a = [{label: this.i18n[this.s.action].submit, fn: function () {
                        this.submit()
                    }}] : d.isArray(a) || (a = [a]);
            ...
            d.each(a, function (a, k) {
                ...
                d("<button/>", {"class": b.classes.form.button + (k.className ? " " + k.className : "")}).html(k.label || "").attr("tabindex",
                        0).on("keyup", function (a) {
        ...
        e.prototype.clear = function (a) {
            ...
            if (a)
                if (d.isArray(a))
                    ...
                    c[a].destroy(), delete c[a], a = d.inArray(a, this.s.order), this.s.order.splice(a, 1);
            else
                d.each(c, function (a) {
                    b.clear(a)
                });
        ...
        e.prototype.display = function (a) {
            return a === l ? this.s.displayed : this[a ? "open" : "close"]()
        };
        ...
        e.prototype.error = function (a, b) {
            b === l ? this._message(this.dom.formError, "fade", a) : this.s.fields[a].error(b);
            return this
        };
        ...
        e.prototype.inline = function (a, b, c) {
            var e = this;
            d.isPlainObject(b) && (c = b, b = l);
            var c = d.extend({}, this.s.formOptions.inline, c), g = this._dataSource("individual", a, b, this.s.fields), f = d(g.node), r = g.field;
            ...
            f.find("div.DTE_Inline_Field").append(r.node());
        ...
        e.prototype.message = function (a, b) {
            b === l ? this._message(this.dom.formInfo, "fade", a) : this.s.fields[a].message(b);
            return this
        };
        e.prototype.modifier =
                function () {
        ...
        e.prototype.remove = function (a, b, c, e, g) {
            ...
            this._assembleMain();
            this._formOptions(r.opts);
            r.maybeOpen();
            r = this.s.editOpts;
            null !== r.focus && d("button",
                    this.dom.buttons).eq(r.focus).focus();
            return this
        };
        ...
        e.prototype.val = function (a, b) {
            return b === l ? this.get(a) : this.set(a, b)
        };
        ...
        e.prototype._constructor = function (a) {
            ...
            this.s = d.extend(!0, {}, e.models.settings,
                    {table: a.domTable || a.table, dbTable: a.dbTable || null, ajaxUrl: a.ajaxUrl, ajax: a.ajax, idSrc: a.idSrc, dataSource: a.domTable || a.table ? e.dataSources.dataTable : e.dataSources.html, formOptions: a.formOptions});
            this.classes = d.extend(!0, {}, e.classes);
            this.i18n = a.i18n;
            var b = this, c = this.classes;
            this.dom = {wrapper: d('<div class="' + c.wrapper + '"><div data-dte-e="processing" class="' + c.processing.indicator + '"></div><div data-dte-e="body" class="' + c.body.wrapper + '"><div data-dte-e="body_content" class="' + c.body.content +
                        '"/></div><div data-dte-e="foot" class="' + c.footer.wrapper + '"><div class="' + c.footer.content + '"/></div></div>')[0], form: d('<form id="my-class" data-dte-e="form" enctype="multipart/form-data" class="' + c.form.tag + '"><div data-dte-e="form_content" class="' + c.form.content + '"/></form>')[0], formError: d('<div data-dte-e="form_error" class="' + c.form.error + '"/>')[0], formInfo: d('<div data-dte-e="form_info" class="' + c.form.info + '"/>')[0], header: d('<div data-dte-e="head" class="' + c.header.wrapper + '"><div class="' + c.header.content + '"/></div>')[0], buttons: d('<div data-dte-e="form_buttons" class="' +
                        c.form.buttons + '"/>')[0]};
            ...
            c.footer = q("foot", f)[0];
            c.body = q("body", f)[0];
            c.bodyContent = q("body_content", f)[0];
            c.processing = q("processing", f)[0];
            a.fields && this.add(a.fields);
            d(n).one("init.dt.dte", function (a, c) {
        ...
        e.prototype._ajax = function (a, b, c) {
            var e =
                    {type: "POST", dataType: "json", data: null, success: b, error: c}, g, f = this.s.action, h = this.s.ajax || this.s.ajaxUrl, f = "edit" === f || "remove" === f ? this._dataSource("id", this.s.modifier) : null;
            ...
            if (d.isFunction(h)) {
                ...
                "string" === typeof h ? -1 !== h.indexOf(" ") ? (g = h.split(" "),
                        e.type = g[0], e.url = g[1]) : e.url = h : e = d.extend({}, e, h || {}), e.url = e.url.replace(/_id_/, f), e.data && (b = d.isFunction(e.data) ? e.data(a) : e.data, a = d.isFunction(e.data) && b ? b : d.extend(!0, a, b)), e.data = a, d.ajax(e)
        };
        ...
        e.prototype._blur = function () {
            ...
            a.blurOnBackground && !1 !== this._event("preBlur") && (a.submitOnBlur ?
                    this.submit() : this._close())
        };
        e.prototype._clearDynamicInfo = function () {
            var a = this.classes.field.error, b = this.dom.wrapper;
            d("div." + a, b).removeClass(a);
            q("msg-error", b).html("").css("display", "none");
            this.error("").message("")
        };
        e.prototype._close = function (a) {
            !1 !== this._event("preClose") && (this.s.closeCb && (this.s.closeCb(a), this.s.closeCb = null), this.s.closeIcb && (this.s.closeIcb(), this.s.closeIcb = null), d("html").off("focus.editor-focus"), this.s.displayed = !1, this._event("close"))
        };
        e.prototype._closeReg =
                function (a) {
                    this.s.closeCb = a
                };
        ...
        e.prototype._displayReorder = function (a) {
            var b = d(this.dom.formContent),
                    c = this.s.fields, a = a || this.s.order;
            b.children().detach();
            d.each(a, function (a, d) {
        ...
        e.prototype._event = function (a, b) {
            ...
            if (d.isArray(a))
                ...
                return c = d.Event(a), d(this).triggerHandler(c, b), c.result
        };
        ...
        e.prototype._focus = function (a, b) {
            var c;
            "number" === typeof b ? c = a[b] : b && (c = 0 === b.indexOf("jq:") ? d("div.DTE " + b.replace(/^jq:/, "")) : this.s.fields[b].focus());
            (this.s.setFocus = c) && c.focus()
        };
        e.prototype._formOptions = function (a) {
            var b =
                    this, c = w++, e = ".dteInline" + c;
            this.s.editOpts = a;
            this.s.editCount = c;
            ...
            d(n).on("keydown" + e, function (c) {
                var e = d(n.activeElement), f = e[0].nodeName.toLowerCase(), k = d(e).attr("type"), f = f === "input" && d.inArray(k, ["color", "date", "datetime", "datetime-local", "email", "month", "number", "password", "range", "search", "tel", "text",
                    "time", "url", "week"]) !== -1;
                if (b.s.displayed && a.submitOnReturn && c.keyCode === 13 && f) {
                    ...
                    e.parents(".DTE_Form_Buttons").length && (c.keyCode === 37 ? e.prev("button").focus() : c.keyCode === 39 && e.next("button").focus())
            });
        ...
        e.prototype._message = function (a, b, c) {
            !c && this.s.displayed ? "slide" === b ? d(a).slideUp() : d(a).fadeOut() : c ? this.s.displayed ? "slide" === b ? d(a).html(c).slideDown() :
                    d(a).html(c).fadeIn() : (d(a).html(c), a.style.display = "block") : a.style.display = "none"
        };
        e.prototype._postopen = function (a) {
            ...
            if ("main" === a || "bubble" === a)
                d("html").on("focus.editor-focus", "body", function () {
                    0 === d(n.activeElement).parents(".DTE").length && b.s.setFocus && b.s.setFocus.focus()
                });
            this._event("open", [a]);
            return!0
        };
        e.prototype._preopen = function (a) {
            if (!1 === this._event("preOpen", [a]))
                return!1;
            this.s.displayed = a;
            return!0
        };
        ...
        e.prototype._submit = function (a, b, c, e) {
            var g = this, f = u.ext.oApi._fnSetObjectDataFn, h = {}, i = this.s.fields, j = this.s.action, m = this.s.editCount, o = this.s.modifier, n = {action: this.s.action, data: {}};
            ...
            !1 === this._event("preSubmit", [n, j]) ? this._processing(!1) : this._ajax(n, function (c) {
                ...
                if (c.error || c.fieldErrors.length) {
                    ...
                    d.each(c.fieldErrors, function (a, b) {
                        ...
                        if (a === 0) {
                            d(g.dom.bodyContent,
                                    g.s.wrapper).animate({scrollTop: d(c.node()).position().top}, 500);
                            c.focus()
                        }
                    });
                    b && b.call(g, c)
                    ...
                    s = c.row !== l ? c.row : h;
                    g._event("setData", [c, s, j]);
                    if (j === "create") {
                        g.s.idSrc === null && c.id ? s.DT_RowId = c.id : c.id && f(g.s.idSrc)(s, c.id);
                        g._event("preCreate", [c, s]);
                        g._dataSource("create", i, s);
                        g._event(["create", "postCreate"], [c, s])
                    } else if (j === "edit") {
                        g._event("preEdit", [c, s]);
                        g._dataSource("edit", o, i, s);
                        g._event(["edit", "postEdit"], [c, s])
                    } else if (j === "remove") {
                        g._event("preRemove", [c]);
                        g._dataSource("remove",
                                o, i);
        ...
        e.prototype._tidy = function (a) {
            return this.s.processing ? (this.one("submitComplete", a), !0) :
                    d("div.DTE_Inline").length ? (this.off("close.killInline").one("close.killInline", a).blur(), !0) : !1
        };
        e.defaults = {table: null, ajaxUrl: null, fields: [], display: "lightbox", ajax: null, idSrc: null, events: {}, i18n: {create: {button: "New", title: "Create new entry", submit: "Create"}, edit: {button: "Edit", title: "Edit entry", submit: "Update"}, remove: {button: "Delete", title: "Delete", submit: "Delete", confirm: {_: "Are you sure you wish to delete %d rows?", 1: "Are you sure you wish to delete 1 row?"}}, error: {system: 'A system error has occurred (<a target="_blank" href="//datatables.net/tn/12">More information</a>).'}},
            formOptions: {bubble: d.extend({}, e.models.formOptions, {title: !1, message: !1, buttons: "_basic"}), inline: d.extend({}, e.models.formOptions, {buttons: !1}), main: d.extend({}, e.models.formOptions)}};
        ...
        j.dataTable = {id: function (a) {
                return C(this.s.table, a, this.s.idSrc)
            }, get: function (a) {
                ...
                if (c) {
                    if (b)
                        ...
                        var h = e.settings()[0].aoColumns[g.column].mData;
                        d.each(c, function (a, b) {
                            b.dataSrc() === h && (f = b)
                        })
                    }
                ...
                if (c.settings()[0].oFeatures.bServerSide)
                    c.draw();
                else if (null !== b) {
                    var e = c.row.add(b);
                    c.draw();
                ...
                b.settings()[0].oFeatures.bServerSide ? b.draw(!1) : (a = b.row(a), null === c ? a.remove().draw(!1) : (a.data(c).draw(!1), B(a.node())))
            }, remove: function (a) {
        ...
        j.html = {id: function (a) {
                ...
                var c = {};
                d.each(b, function (a, b) {
                    var e = d('[data-editor-field="' +
                            b.dataSrc() + '"]').html();
                    b.valToData(c, null === e ? l : e)
                });
                return c
            }, node: function () {
                return n
        ...
        d.fn.dataTable.TableTools &&
                (j = d.fn.dataTable.TableTools.BUTTONS, j.editor_create = d.extend(!0, j.text, {sButtonText: null, editor: null, formTitle: null, formButtons: [{label: null, fn: function () {
                                this.submit()
                    ...
                    }}), j.editor_edit = d.extend(!0, j.select_single, {sButtonText: null, editor: null, formTitle: null, formButtons: [{label: null, fn: function () {
                                this.submit()
                            }}], fnClick: function (a, b) {
                    ...
                    }}), j.editor_remove = d.extend(!0, j.select, {sButtonText: null, editor: null, formTitle: null, formButtons: [{label: null, fn: function () {
                                var a = this;
                        ...
                        var c = this.fnGetSelectedIndexes();
                        if (c.length !== 0) {
                            var d = b.editor, e = d.i18n.remove,
                                    f = b.formButtons, h = e.confirm === "string" ? e.confirm : e.confirm[c.length] ? e.confirm[c.length] : e.confirm._;
                            if (!f[0].label)
                                f[0].label = e.submit;
        ...
        var z = function (a, b) {
            if (d.isArray(a))
                for (var c = 0, e = a.length; c < e; c++) {
                    var f = a[c];
                    d.isPlainObject(f) ? b(f.value === l ? f.label : f.value, f.label, c) : b(f, f, c)
                }
            else {
                c = 0;
                d.each(a, function (a, d) {
        ...
        }, o = e.fieldTypes, j = d.extend(!0, {}, e.models.fieldType, {get: function (a) {
                return a._input.val()
            },
            set: function (a, b) {
        ...
        o.hidden = d.extend(!0, {}, j, {create: function (a) {
                a._val = a.value;
                return null
            }, get: function (a) {
                return a._val
        ...
        o.readonly = d.extend(!0, {}, j, {create: function (a) {
                a._input = d("<input/>").attr(d.extend({id: a.id, type: "text", readonly: "readonly"}, a.attr || {}));
                return a._input[0]
            }});
        o.text = d.extend(!0, {}, j, {create: function (a) {
                a._input =
                        d("<input/>").attr(d.extend({id: a.id, type: "text"}, a.attr || {}));
                return a._input[0]
            }});
        o.password = d.extend(!0, {}, j, {create: function (a) {
                a._input = d("<input/>").attr(d.extend({id: a.id, type: "password"}, a.attr || {}));
                return a._input[0]
            }});
            
        /* My custom code start*/
        o.file = d.extend(!0, {}, j, {create: function (a) {
                a._input = d("<input/>").attr(d.extend({id: a.id, type: "file"}, a.attr || {}));
                return a._input[0]
            }});
         
        /* My custom code end*/
        o.textarea = d.extend(!0, {}, j, {create: function (a) {
                a._input = d("<textarea/>").attr(d.extend({id: a.id}, a.attr || {}));
                return a._input[0]
            }});
        o.select = d.extend(!0, {}, j, {_addOptions: function (a, b) {
            ...
            create: function (a) {
                a._input = d("<select/>").attr(d.extend({id: a.id, multiple:a.multiple}, a.attr || {}));
        ...
        o.checkbox = d.extend(!0, {}, j, {_addOptions: function (a, b) {
        ...
        o.radio = d.extend(!0, {}, j, {_addOptions: function (a, b) {
                var c = a._input.empty();
        ...
        o.date = d.extend(!0, {}, j, {create: function (a) {
                if (!d.datepicker) {
                    a._input = d("<input/>").attr(d.extend({id: a.id, type: "date"}, a.attr || {}));
                    return a._input[0]
                }
                a._input = d("<input />").attr(d.extend({type: "text", id: a.id, "class": "jqueryui"}, a.attr || {}));
                if (!a.dateFormat)
                    a.dateFormat = d.datepicker.RFC_2822;
                if (a.dateImage === l)
                    a.dateImage = "../../images/calender.png";
                setTimeout(function () {
                    d(a._input).datepicker(d.extend({showOn: "both", dateFormat: a.dateFormat, buttonImage: a.dateImage,
                        buttonImageOnly: true}, a.opts));
    ...
    "function" === typeof define && define.amd ? define(["jquery",
        "datatables"], w) : "object" === typeof exports ? w(require("jquery"), require("datatables")) : jQuery && !jQuery.fn.dataTable.Editor && w(jQuery, jQuery.fn.dataTable)
})(window, document);
